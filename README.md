...
- C++ support: `assigning to 'char *' from incompatible type 'void *'`, `cannot initialize a variable of type 'char *' with an rvalue of type 'const void *'`, `invalid suffix on literal; C++11 requires a space between literal and identifier`
